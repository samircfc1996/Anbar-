...
$sec=mysqli_query($con,"SELECT 
						a.id,a.foto,a.ad AS m_ad, a.alis, a.satis, a.miqdar, a.tarix, a.defect, b.ad AS b_ad
 						...
 						WHERE a.brand=b.id AND a.id='".$_GET['x']."'");
$info=mysqli_fetch_array($sec);
// Set some content to print
$html = '
<h2>'.$info['m_ad'].' məhsulu üzrə çıxarış</h2>
	  <b>Brend: </b>'.$info['b_ad'].'<br>
      <b>Məhsul: </b>'.$info['m_ad'].'<br>
      <b>Alış qiyməti: </b>'.$info['alis'].'<br>
      <b>Satış qiyməti </b>'.$info['satis'].'<br>
      <b>Miqdarı: </b>'.$info['miqdar'].'<br>
      <b>Defekt: </b>'.$info['defect'].'<br>
